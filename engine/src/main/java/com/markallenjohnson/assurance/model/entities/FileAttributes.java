...
public class FileAttributes
{
	...
	/**
	 * Re-reads every persisted column from the file on disk. Call after merge,
	 * restore, or other operations that change bytes or metadata at this
	 * reference's path so the UI and persistence match the filesystem.
	 */
	public void refreshFrom(File file, IFileComparer comparer)
	{
		this.captureFileAttributes(file, comparer);
	}
