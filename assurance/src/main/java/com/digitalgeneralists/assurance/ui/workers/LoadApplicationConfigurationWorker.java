...
public class LoadApplicationConfigurationWorker extends SwingWorker<ApplicationConfiguration, Object>
{
	private Logger logger = Logger.getLogger(LoadApplicationConfigurationWorker.class);

	private INotificationProvider notifier;

	public LoadApplicationConfigurationWorker(INotificationProvider notifier)
	{
	...
	protected void done()
	{
		try
		{
			this.notifier.fireEvent(new ApplicationConfigurationLoadedEvent(this.get()));
		}
		catch (InterruptedException e)
		{
			logger.info("Load application configuration was aborted.");
		}
