...
import com.markallenjohnson.assurance.notification.events.ScanDefinitionSavedEvent;

public class SaveScanDefinitionWorker extends SwingWorker<Object, Object>
{
	private ScanDefinition scanDefinition;

	private INotificationProvider notifier;

	public SaveScanDefinitionWorker(ScanDefinition scanDefinition, INotificationProvider notifier)
	{
	...
	protected void done()
	{
		try
		{
			this.notifier.fireEvent(new ScanDefinitionSavedEvent(this));
		}
		finally
		{
